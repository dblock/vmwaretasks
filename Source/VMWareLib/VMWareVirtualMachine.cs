...
namespace Vestris.VMWareLib
{
    public class VMWareVirtualMachine
    {
        ...
        private VMWareSnapshot FindSnapshot(string name)
        {
        ...
        private VMWareSnapshot GetCurrentSnapshot()
        {
            ISnapshot snapshot = null;
        ...
        public int Execute(string path, string parameters, int timeoutInSeconds)
        {
            ...
            return Convert.ToInt32(job.Wait<object[]>(properties, timeoutInSeconds)[0]);
        }
        ...
        public bool FileExistsInGuest(string guestPathName, int timeoutInSeconds)
        {
            ...
            return Convert.ToBoolean(job.Wait<object[]>(properties, timeoutInSeconds)[0]);
        }
